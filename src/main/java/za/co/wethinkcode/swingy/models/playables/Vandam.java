...
@Setter
@Getter
public class Vandam extends Player
{

    public Vandam(String name, String type, int level, int exp, int atk, int def, int hp,
                  Coordinates coordinates)
    {
        super(name,type, level, exp, atk, def, hp, coordinates);
    }

    public Vandam(String name, Coordinates coordinates)
    {
        super(name,"Vandam", 1, 1000, 80, 15, 350, coordinates);
    }
